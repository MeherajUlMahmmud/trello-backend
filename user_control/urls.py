...
urlpatterns = [
    ...
    path('auth/password-change/',
         PasswordChangeAPIView.as_view(), name="password_change"),
    path('auth/token/refresh/', TokenRefreshView.as_view(), name='token_refresh'),
    path('auth/request-password-reset/',
         RequestPasswordResetAPIView.as_view(), name="request_password_reset"),
    path('auth/password-reset/<uidb64>/<token>/',
         PasswordResetAPIView.as_view(), name='password_reset_confirm'),
    ...
    path('user/<str:pk>/details/',
         GetUserDetailsAPIView.as_view(), name='get_user_details'),
    path('user/<str:pk>/update/', UpdateUserDetailsAPIView.as_view(),
         name='update_user_details'),
    path('user/<str:pk>/update-profile-picture/',
         UpdateProfilePictureAPIView.as_view(), name='update_profile_picture'),
]
